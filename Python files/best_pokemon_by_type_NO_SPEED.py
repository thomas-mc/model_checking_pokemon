...
with open('University Work\\model_checking_pokemon\\Python files\\pokedex_no_legends.txt') as json_file:
...
for pokemon in pokedex:
    pokedex[pokemon]["base_stats"]["Total"] = pokedex[pokemon]["base_stats"]["HP"] + pokedex[pokemon]["base_stats"]["Attack"] + pokedex[pokemon]["base_stats"]["Defense"] + pokedex[pokemon]["base_stats"]["Special"]
