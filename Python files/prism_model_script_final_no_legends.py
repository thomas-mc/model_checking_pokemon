...
with open('University Work\\model_checking_pokemon\\Python files\\teams_no_legends_no_speed.txt') as json_file:
...
for team in teams:
    ...
    for pokemon in teams[team]:
        ...
        for dex_pokemon in pokedex:
            if(pokedex[dex_pokemon]['name'] == pokemon):
                live_stats['p1p{0}_attack'.format(team1_poke_count)] = pokedex[dex_pokemon]['base_stats']['Attack']
                live_stats['p1p{0}_defense'.format(team1_poke_count)] = pokedex[dex_pokemon]['base_stats']['Defense']
                live_stats['p1p{0}_special'.format(team1_poke_count)] = pokedex[dex_pokemon]['base_stats']['Special']
                live_stats['p1p{0}_type'.format(team1_poke_count)] = pokedex[dex_pokemon]['type']
        team1_poke_count += 1
        ...
        if str(teams[adversary_team]) != str(teams[team]):
            if teams_already_matched[str(teams[adversary_team])][str(teams[team])] == False:
                ...
                for pokemon in teams[adversary_team]:
                    ...
                    for dex_pokemon in pokedex:
                        if(pokedex[dex_pokemon]['name'] == pokemon):
                            live_stats['p2p{0}_attack'.format(team2_poke_count)] = pokedex[dex_pokemon]['base_stats']['Attack']
                            live_stats['p2p{0}_defense'.format(team2_poke_count)] = pokedex[dex_pokemon]['base_stats']['Defense']
                            live_stats['p2p{0}_special'.format(team2_poke_count)] = pokedex[dex_pokemon]['base_stats']['Special']
                            live_stats['p2p{0}_type'.format(team2_poke_count)] = pokedex[dex_pokemon]['type']
                    team2_poke_count += 1
                        ...
                        for move_counter in range(1,5):
                            for adv_pokemon_counter in range(1,4):
                                ...
                                if player_counter == 1:
                                    ...
                                    power = moves[learnsets[live_stats['p2p{0}_pokemon'.format(pokemon_counter)]][move_counter-1]]['Power']
                                    attack = live_stats['p2p{0}_attack'.format(pokemon_counter)]
                                    defense = live_stats['p1p{0}_defense'.format(adv_pokemon_counter)]
                                    if moves[learnsets[live_stats['p2p{0}_pokemon'.format(pokemon_counter)]][move_counter-1]]['type'] in  live_stats['p2p{0}_type'.format(pokemon_counter)]:
                                        stab = 1.5
                                ...
                                # if player_counter == 1:
                                #     if team == "best_total":
                                #         if adversary_team == "most_type_advantages":
                                #             print("team: " + str(teams[team]))
                                #             print("adv_team: " + str(teams[adversary_team]))
                                #             print("current pokemon: " + str([live_stats['p{0}p{1}_pokemon'.format(player_counter, pokemon_counter)]]))
                                #             print("learnset: " + str(learnsets[live_stats['p{0}p{1}_pokemon'.format(player_counter, pokemon_counter)]]))
                                #             print("current move: " + str(learnsets[live_stats['p{0}p{1}_pokemon'.format(player_counter, pokemon_counter)]][move_counter-1]))
                                #             print("supposed power: " + str(moves[learnsets[live_stats['p{0}p{1}_pokemon'.format(player_counter, pokemon_counter)]][move_counter-1]]['Power']))
                                #             print("supposed attack: " + str(live_stats['p{0}p{1}_attack'.format(player_counter,pokemon_counter)]))
                                #             print("Poke counter: " + str(pokemon_counter))
                                #             print("move counter: " + str(move_counter))
                                #             print("adv poke counter: " + str(adv_pokemon_counter))
                                #             print("type effect: " + str(type_effectiveness))
                                #             print("stab: " + str(stab))
                                #             print("level: " + str(level))
                                #             print("rand: " + str(random_var))
                                #             print("attack: " + str(attack))
                                #             print("defense: " + str(defense))
                                #             print("power: " + str(power))
                                #             print("damage: " + str(math.floor(((((((2*level)/5)+2)*power*(attack/defense))/50)+2) * random_var * stab * type_effectiveness)))
                                #             print("--------------------------------------------")
                ...
                f=open("University Work\\model_checking_pokemon\\Prism_Models_No_Legends_No_Speed\\{0}_VERSUS_{1}.prism".format(team,adversary_team),'w')
                sys.stdout = f
                # -----------------------------------------------------------------------------
